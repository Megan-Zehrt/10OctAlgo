...
console.log(binarySearch(two_numbers1, two_expected1))
console.log(binarySearch(two_numbers2, two_expected2))
console.log(binarySearch(two_numbers3, two_expected3))